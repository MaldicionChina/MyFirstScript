...
pathUser=$(./FindPath.awk userPath.txt) # se ejecuta el script de awk que retornar al ruta del 

if [ "$pathUser" != "Not_Found" ]
then
...
echo " No se encontro el usuario, verifique que esté escrito correctamente"
